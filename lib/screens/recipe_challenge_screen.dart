...
class RecipeChallengeScreen extends StatelessWidget {
                ...
                >(
                  selector: (state) {
                    ...
                    return (
                      ...
                      elapsedTimeFormatted: _formatDuration(state.elapsedTime),
  ...
  ShaderMask _nextUpSection(({TextColor acceptanceMarginStatusColor, int currentStepIndex, Duration elapsedTime, String elapsedTimeFormatted, bool nextUp, Duration totalElapsedTime}) data) {
    return ShaderMask(
                          shaderCallback: (bounds) => const LinearGradient(
                            begin: Alignment.topCenter,
                            end: Alignment.bottomCenter,
                            colors: [
                              Color.fromRGBO(14, 17, 24, 0),
                              Color.fromRGBO(14, 17, 24, 1),
                            ],
                          ).createShader(bounds),
                          blendMode:
                              BlendMode.darken, // try overlay/darken too
                          child: StepCard(
  ...
  Stack _timerSection(({TextColor acceptanceMarginStatusColor, int currentStepIndex, Duration elapsedTime, String elapsedTimeFormatted, bool nextUp, Duration totalElapsedTime}) data) {
    return Stack(
  ...
  StepCard _currentStepCard(({TextColor acceptanceMarginStatusColor, int currentStepIndex, Duration elapsedTime, String elapsedTimeFormatted, bool nextUp, Duration totalElapsedTime}) data) => StepCard(step: recipe.steps[data.currentStepIndex]);

  Text _stepDisplaySection(({TextColor acceptanceMarginStatusColor, int currentStepIndex, Duration elapsedTime, String elapsedTimeFormatted, bool nextUp, Duration totalElapsedTime}) data) {
    return Text.rich(
                        TextSpan(
                          children: [
                            TextSpan(
